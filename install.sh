...
[ "$(uname 2> /dev/null)" == "Dawin" ] && ln -s $LOCATION/.zshrc-Dawin ~/.zshrc-Dawin
...
[ "$(uname 2> /dev/null)" == "Dawin" ] && ln -s "$LOCATION/vscode/settings.json" "$HOME/Library/Application Support/Code/User/settings.json"
