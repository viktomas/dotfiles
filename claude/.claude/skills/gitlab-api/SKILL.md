...
```bash
~/.claude/skills/gitlab-api/scripts/list-todos.sh                                    # all pending
~/.claude/skills/gitlab-api/scripts/list-todos.sh --action review_requested          # only review requests
~/.claude/skills/gitlab-api/scripts/list-todos.sh --state done --type MergeRequest   # done MR TODOs
```
